...
struct PackedImageDesc::Impl
{
    ...
    void initValues()
    {
        ...
        {
            m_rData = m_data;
            m_gData = static_cast<char*>(m_rData) + m_chanStrideBytes;
            m_bData = static_cast<char*>(m_rData) + 2 * m_chanStrideBytes;
            if(m_numChannels==4)
            {
                m_aData = static_cast<char*>(m_rData) + 3 * m_chanStrideBytes;
            }
            else
            {
                m_aData = nullptr;
        ...
        {
            m_bData = m_data;
            m_gData = static_cast<char*>(m_bData) + m_chanStrideBytes;
            m_rData = static_cast<char*>(m_bData) + 2 * m_chanStrideBytes;
            if(m_numChannels==4)
            {
                m_aData = static_cast<char*>(m_bData) + 3 * m_chanStrideBytes;
            }
            else
            {
                m_aData = nullptr;
        ...
        {
            m_aData = m_data;
            m_bData = static_cast<char*>(m_aData) + m_chanStrideBytes;
            m_gData = static_cast<char*>(m_aData) + 2 * m_chanStrideBytes;
            m_rData = static_cast<char*>(m_aData) + 3 * m_chanStrideBytes;
        }
        else
        {
    ...
    bool isRGBAPacked() const
    {
        ...
        if(static_cast<char*>(m_gData)-static_cast<char*>(m_rData) != m_chanStrideBytes) return false;
        if(static_cast<char*>(m_bData)-static_cast<char*>(m_gData) != m_chanStrideBytes) return false;
        if(static_cast<char*>(m_aData)-static_cast<char*>(m_bData) != m_chanStrideBytes) return false;
