                                ...
                                TransformDirection dir) const
{
    ...
    case TRANSFORM_DIR_INVERSE:
    {
        ...
        {
            const GammaOpData::Params redParams   = { double(cachedFile->mGammaRGB[0]) };
            const GammaOpData::Params greenParams = { double(cachedFile->mGammaRGB[1]) };
            const GammaOpData::Params blueParams  = { double(cachedFile->mGammaRGB[2]) };
            const GammaOpData::Params alphaParams = { double(cachedFile->mGammaRGB[3]) };
