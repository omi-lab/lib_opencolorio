                                      ...
                                      Interpolation /*interp*/) const
{
    ...
    cachedFile->m44[0] =  double(floatArray[0]);
    cachedFile->m44[1] =  double(floatArray[1]);
    cachedFile->m44[2] =  double(floatArray[2]);
    cachedFile->m44[3] =  0.0;

    cachedFile->m44[4] =  double(floatArray[4]);
    cachedFile->m44[5] =  double(floatArray[5]);
    cachedFile->m44[6] =  double(floatArray[6]);
    cachedFile->m44[7] =  0.0;

    cachedFile->m44[8] =  double(floatArray[8]);
    cachedFile->m44[9] =  double(floatArray[9]);
    cachedFile->m44[10] = double(floatArray[10]);
    ...
    cachedFile->offset4[0] = double(floatArray[3]) / 65535.0;
    cachedFile->offset4[1] = double(floatArray[7]) / 65535.0;
    cachedFile->offset4[2] = double(floatArray[11]) / 65535.0;
