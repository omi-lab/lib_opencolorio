...
void Lin2LogRenderer::updateData(ConstLogOpDataRcPtr & log)
{
    ...
    m_klog[0] = float(m_paramsR[LOG_SIDE_SLOPE] / log2(double(m_base)));
    m_klog[1] = float(m_paramsG[LOG_SIDE_SLOPE] / log2(double(m_base)));
    m_klog[2] = float(m_paramsB[LOG_SIDE_SLOPE] / log2(double(m_base)));
...
{
    L2LBaseRenderer::updateData(log);
    m_linearSlope[0] = LogUtil::GetLinearSlope(m_paramsR, double(m_base));
    m_linearSlope[1] = LogUtil::GetLinearSlope(m_paramsG, double(m_base));
    m_linearSlope[2] = LogUtil::GetLinearSlope(m_paramsB, double(m_base));
    m_logSideBreak[0] = LogUtil::GetLogSideBreak(m_paramsR, double(m_base));
    m_logSideBreak[1] = LogUtil::GetLogSideBreak(m_paramsG, double(m_base));
    m_logSideBreak[2] = LogUtil::GetLogSideBreak(m_paramsB, double(m_base));
...
void CameraLin2LogRenderer::updateData(ConstLogOpDataRcPtr & log)
{
    ...
    m_b[1] = float(m_paramsG[LIN_SIDE_OFFSET]);
    m_b[2] = float(m_paramsB[LIN_SIDE_OFFSET]);
    m_klog[0] = float(m_paramsR[LOG_SIDE_SLOPE] / double(m_log2_base));
    m_klog[1] = float(m_paramsG[LOG_SIDE_SLOPE] / double(m_log2_base));
    m_klog[2] = float(m_paramsB[LOG_SIDE_SLOPE] / double(m_log2_base));
    m_kb[0] = float(m_paramsR[LOG_SIDE_OFFSET]);
    m_kb[1] = float(m_paramsG[LOG_SIDE_OFFSET]);
    m_kb[2] = float(m_paramsB[LOG_SIDE_OFFSET]);
